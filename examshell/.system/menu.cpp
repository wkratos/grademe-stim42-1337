...
void exam::exam_help()
{
    ...
    std::cout << std::endl << WHITE << BOLD << "Project credits:" << RESET << std::endl;
    std::cout << "    Original project: " << LIME << BOLD << "@jcluzet" << RESET << std::endl;
    std::cout << "    Maintained, expanded, and improved: " << LIME << BOLD << "@wkratos" << RESET << std::endl;
    std::cout << "    Week 03, Week 04 Final, expanded exercise support," << std::endl;
    std::cout << "    reliability, tester, and terminal-interface improvements." << std::endl;
    std::cout << "    " << CYAN << BOLD << "github.com/wkratos" << RESET << std::endl;
}
...
int exam::stud_or_swim(void)
{
    ...
    {
        system("clear");
        std::cout << WHITE << BOLD << "                  42EXAM" << RESET << std::endl;
        if(vip)
            std::cout << "    You are a " << LIME << "VIP" << WHITE << BOLD << " user" << RESET << std::endl << std::endl;
        else
            std::cout << WHITE << BOLD << "        Original project by " << LIME << BOLD << "@jcluzet" << RESET << std::endl
                  << WHITE << BOLD << "  MAINTAINED, EXPANDED & IMPROVED BY " << LIME << BOLD << "@wkratos" << RESET << std::endl
                  << CYAN << BOLD << "             github.com/wkratos" << RESET << std::endl
                  << WHITE << "     Week 03 + Week 04 Final | More exercises" << RESET << std::endl
                  << WHITE << "        Reliability, testers & interface" << RESET << std::endl
                  << std::endl
                  << std::endl;
