...
void exam::end_exam()
{
    ...
    std::cout << "Original project by " << LIME << BOLD << "@jcluzet" << RESET << std::endl;
    std::cout << "Maintained, expanded, and improved by " << LIME << BOLD << "@wkratos" << RESET << std::endl;
    std::cout << CYAN << BOLD << "github.com/wkratos" << RESET << std::endl;
    std::cout << "Week 03, Week 04 Final, expanded exercises, reliability," << std::endl;
    std::cout << "tester, and terminal-interface improvements by @wkratos." << std::endl;
    std::cout << "\n\e[1m\e[96mA word from the original creator:\e[0m\n"
              << std::endl;
